...
import CreatePaymentMessage from "../../../components/createPayMessage";
...
const Index = (props: IndexProps) => {
  ...
  */
  ...
  /*
  onInvite handeling 2
  */
  const onInviteContact2 = (data: any) => {
    dispatch(inviteContact(data));
  };
  useEffect(() => {
    if (isContactInvited) {
        ...
        <div className="px-4 pt-4">
          <div className="d-flex align-items-start">
            ...
            <div className="d-flex align-items-start">
              <div id="add-payment">
                {/* Button trigger modal */}
                <Button onClick={openModal2}>Create Payment Message</Button>
              </div>
              <UncontrolledTooltip target="add-payment" placement="bottom">
                Create Payment
              </UncontrolledTooltip>
            </div>
          {/* <Form>
